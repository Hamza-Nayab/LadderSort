...
To complement the synthetic workloads, we evaluate one public real-world event trace derived from GH Archive. GH Archive records the public GitHub event timeline and provides hourly JSON archives. We use eight hourly archives from 2015-01-01 at 0, 3, 6, 9, 12, 15, 18, and 21 UTC.
