...
\begin{figure}[H]
\centering
\includegraphics[width=0.82\linewidth]{media/media/image2.jpg}
\caption{Implementation flowchart of LadderSort. The diagram summarizes the decomposition and merge control flow after the conceptual overview in Figure~\ref{fig:overview}.}
