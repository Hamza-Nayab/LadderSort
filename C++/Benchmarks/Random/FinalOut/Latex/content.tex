...
\caption{Methodology overview of LadderSort, showing that the algorithm first decomposes the input into ladders and then merges them according to the measured ladder count \(K\).}
\label{fig:overview}
\end{figure}
